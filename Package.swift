...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
          ...
          url: "https://guru-dist.s3.us-west-2.amazonaws.com/xcframework/guru-engine/20231128/guru-engine.xcframework.zip",
          checksum: "1ebb78078d27e414e147afad39db8cbdd8e2f37a4c0baf53260d32884e7d9f3e"
        ),
        .binaryTarget(
          name: "quickjs",
