...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
          ...
          url: "https://guru-dist.s3.us-west-2.amazonaws.com/xcframework/guru-engine/20231102/guru-engine.xcframework.zip",
          checksum: "22cf2603a38b4180b7255b08b34b92b19725acd9ef598673d6ce9564093a0d12"
        ),
        .binaryTarget(
          name: "quickjs",
