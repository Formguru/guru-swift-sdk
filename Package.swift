...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
          ...
          url: "https://guru-dist.s3.us-west-2.amazonaws.com/xcframework/guru-engine/20231105/guru-engine.xcframework.zip",
          checksum: "839d91b5ef0c415631c31daec66016b7a3828a5d02c7284e7102a6e4436b8731"
        ),
        .binaryTarget(
          name: "quickjs",
