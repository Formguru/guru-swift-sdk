...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
          ...
          url: "https://guru-dist.s3.us-west-2.amazonaws.com/xcframework/guru-engine/20230921/guru-engine.xcframework.zip",
          checksum: "bc3d6d1f09c66046115ac260e09fda6000481cb1caff399c191702b05da97303"
        ),
        .binaryTarget(
          name: "quickjs",
