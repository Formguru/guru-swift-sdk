...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
          ...
          url: "https://guru-dist.s3.us-west-2.amazonaws.com/xcframework/guru-engine/20230926/guru-engine.xcframework.zip",
          checksum: "b9d69fba8c524558afeec0bacf097baae4eb1afa18865552a15a32de38ffa47c"
        ),
        .binaryTarget(
          name: "quickjs",
