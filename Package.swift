...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
          ...
          url: "https://guru-dist.s3.us-west-2.amazonaws.com/xcframework/guru-engine/20231121/guru-engine.xcframework.zip",
          checksum: "83b5947d5b7f62e98a00f4a63263d3755a10744d056121bd1457cdbb4f842728"
        ),
        .binaryTarget(
          name: "quickjs",
